<br>
 <div class="container-fluid mb-5">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Apresentação do Aluno e Quais Cursos ele Está Cursando !</li>
      </ol>
            ...
            if(isset($user_data)) {
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button class="btn btn-outline-secondary btn-alterar" data-toggle="modal" data-user='<?php echo json_encode($row);?>' ><i class="far fa-eye"></i></button><span class="pr-3"></span>
