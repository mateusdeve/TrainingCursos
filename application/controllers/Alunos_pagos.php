...
class Alunos_pagos extends CI_Controller {
    ...
    public function __construct(){
        ...
        $this->load->model('alunos_pagos_model');
        $this->valida_logado();
	...
	public function index() {
		...
		$this->load->model('alunos_pagos_model');
		$data['user_data'] = $this->alunos_pagos_model->listar_usuario();

		$this->load->view('head',$data);
		$this->load->view('menu',$data);
		$this->load->helper('form');
		$this->load->view('modal_excluir_pagos',$data);
        $this->load->view('modal_alterar_pagos',$data);
        $this->load_modal();
    ...
    {	
        ...
        {
            $deleted = $this->alunos_pagos_model->deletar_usuario($this->post['id_usuario']);
            if($deleted)
            {
                $modal = array(
                            'success'	=> TRUE,
     ...
     public function alterar_usuario()
    {
        ...
        $alterar= $this->alunos_pagos_model->alterar_usuario($this->post);
        if($alterar)
        {
            $modal = array(
                        'success' => TRUE,
