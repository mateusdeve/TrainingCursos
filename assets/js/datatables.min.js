...
e?d[0]:d,d=e?d[1]:d,e=h("<select/>",{name:c+"_length","aria-controls":c,"class":b.sLengthSelect.h-100}),g=0,j=f.length;g<j;g++)e[0][g]=new Option("number"===typeof d[g]?a.fnFormatNumber(d[g]):d[g],f[g]);var i=h("<div><label/></div>").addClass(b.sLength);a.aanFeatures.l||(i[0].id=c+"_length");i.children().append(a.oLanguage.sLengthMenu.replace("_MENU_",e[0].outerHTML));h("select",i).val(a._iDisplayLength).on("change.DT",function(){Ra(a,h(this).val());P(a)});h(a.nTable).on("length.dt.DT",function(b,c,d){a===
...
oPaginate:{sFirst:"First",sLast:"Last",sNext:"Próximo",sPrevious:"anterior"},sEmptyTable:"No data available in table",sInfo:"Mostrando _START_ até _END_ de _TOTAL_ entradas",sInfoEmpty:"Mostrando 0 to 0 of 0 entradas",sInfoFiltered:"(Filtrado de  _MAX_ Total Entradas)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Exposição _MENU_ entradas",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Busca:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:h.extend({},
